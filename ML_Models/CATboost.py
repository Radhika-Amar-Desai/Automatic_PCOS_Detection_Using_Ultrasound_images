...
# Create and train the CATBoost classifier with PCA
catboost_classifier = CatBoostClassifier(iterations=100, depth=6, learning_rate=0.1, random_state=42)
catboost_classifier.fit(X_train_pca, y_train)
